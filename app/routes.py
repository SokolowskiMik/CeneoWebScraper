...
def product(product_code):
    # pobranie z plikow json pini o produkcie i statystyki do dataframe albo listy slownikow
    # przekazanie opinii i statystyk do szablonu html
    return render_template("product.html", product_code=product_code)
# moze byc jako modal czyli przycisk i wyswietla sie na tej samej stronie bootstrap modal
